...
public class DentistDaoH2  implements IDao<Dentist>{
    ...
    private static final String SQL_INSERT="INSERT INTO DENTISTS (REGISTRATION,NAME,LAST_NAME)" +
            "VALUES (?,?,?)";
    ...
    public Dentist findById(Integer id) {
        ...
        try {
            ...
            if (rs.next()) {
                dentist.setId(rs.getInt(1));
                dentist.setRegistration(rs.getInt(2));
                dentist.setName(rs.getString(3));
                dentist.setLastName(rs.getString(4));
